...
import { getUserProfileById, editOwnProfile, suggestedUsers, followOrUnfollowUser } from "../controllers/user.controller.js";
...
router.get("/suggestedUsers", requireAuth(), suggestedUsers); // get users to follow
